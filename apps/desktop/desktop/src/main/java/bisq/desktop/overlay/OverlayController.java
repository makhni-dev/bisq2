...
import bisq.desktop.main.content.bisq_easy.trade_details.TradeDetailsController;
...
public class OverlayController extends NavigationController {
    ...
    protected Optional<? extends Controller> createController(NavigationTarget navigationTarget) {
        return switch (navigationTarget) {
            ...
            case TRADE_DETAILS -> Optional.of(new TradeDetailsController(serviceProvider));
